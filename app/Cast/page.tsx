...
import { 
  ...
  FaTimes, FaBolt, FaSpinner, FaInfoCircle, FaShareAlt 
} from "react-icons/fa";
...
export default function Voting() {
  ...
  // --- 2. POLLING SYSTEM (Replaces Websockets for Firewall Support) ---
  useEffect(() => {
