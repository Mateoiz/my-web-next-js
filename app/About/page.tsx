...
import { 
  motion, 
  useMotionValue, 
  useTransform, // Fixed: Ensured this is imported
  animate, 
  useInView,
  AnimatePresence 
} from "framer-motion";
...
// --- STATIC DATA ---
const VISION_TEXT = "To be a leading organization that cultivates world-class Computer Science students who demonstrate leadership, integrity, and innovation, and who make a meaningful impact on the ICT industry, the university, and society.";

const MISSION_TEXT = "An organization actively engaged in ICT related concerns, promoting learning, innovation, and ethical practices while encouraging growth, excellence, and leadership among its members.";
    ...
    <section className="min-h-screen relative overflow-hidden pb-32 transition-colors duration-300">
      ...
      <div className="container mx-auto px-6 pt-32 relative z-10">
       ...
       <div className="flex justify-center mb-40 px-4">
        ...
        {/* --- VISION & MISSION (REDESIGNED LAYOUT) --- */}
        {/* Switched to a unified panel to prevent empty space from short text */}
        <div className="mb-40 max-w-6xl mx-auto">
            <div className="relative rounded-3xl bg-white/50 dark:bg-zinc-900/80 backdrop-blur-md border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-xl dark:shadow-2xl">
                
                {/* Decorative Top Line */}
                <div className="absolute top-0 left-0 w-full h-[2px] bg-linear-to-r from-transparent via-green-500 to-transparent opacity-70" />

                <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-zinc-200 dark:divide-zinc-800">
                    
                    {/* VISION SECTION */}
                    <div className="p-10 md:p-14 relative group">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="w-3 h-3 bg-green-500 rounded-full shadow-[0_0_10px_rgba(34,197,94,0.8)]" />
                            <h3 className="text-3xl font-black text-zinc-900 dark:text-white tracking-wide uppercase">VISION</h3>
                        </div>
                        <p className="text-zinc-600 dark:text-gray-300 leading-relaxed text-lg font-light">
                            {VISION_TEXT}
                        </p>
                        {/* Hover Effect */}
                    ...
                    <div className="p-10 md:p-14 relative group">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="w-3 h-3 bg-green-500 rounded-full shadow-[0_0_10px_rgba(34,197,94,0.8)]" />
                            <h3 className="text-3xl font-black text-zinc-900 dark:text-white tracking-wide uppercase">MISSION</h3>
                        </div>
                        <p className="text-zinc-600 dark:text-gray-300 leading-relaxed text-lg font-light mb-8">
                            {MISSION_TEXT}
                        </p>
                        
                        {/* TAGS */}
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-500/30">
                            <span className="text-green-700 dark:text-green-400 text-sm font-bold tracking-wide">
                ...
                <div className="absolute bottom-0 w-full h-24 opacity-5 dark:opacity-10 pointer-events-none">
