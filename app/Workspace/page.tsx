...
import { 
  ...
  FaEye, FaEyeSlash, FaLock // <-- ADDED FaLock
} from "react-icons/fa";
...
// Lazy loading only the allowed public tools
...
export default function WorkspaceHub() {
  ...
  // Removed 'flashcards' from allowed active tools
    ...
    <section className="min-h-screen pt-28 md:pt-32 pb-24 md:pb-32 px-4 md:px-8 relative overflow-hidden bg-zinc-50 dark:bg-black font-sans selection:bg-green-500/30 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <AnimatePresence mode="wait">
          ...
          {!activeTool && (
            <motion.div key="hub" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-4 md:space-y-6">
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    {!needsSetup ? (
                      ...
                      >
                        ...
                        {/* --- ADDED LOG IN BUTTON NEXT TO GOOGLE --- */}
                        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto mt-4 md:mt-0">
                          ...
                          >
                             {isAuthenticating ? <span className="animate-spin rounded-full h-5 w-5 border-b-2 border-black"></span> : <FaGoogle />}
                      ...
                      >
                        <div className="text-left w-full md:w-auto mt-4">
                          ...
                          <p className="text-zinc-400 max-w-xl text-xs sm:text-sm md:text-base leading-relaxed">
                            Google verified! Set up your username and password below. You will use these to log in seamlessly next time.
                          </p>
                        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                ...
                {/* --- FLASHCARD MAKER MODIFIED TO ACT AS A REDIRECT --- */}
                <motion.button 
                  onClick={() => router.push('/login')} 
                  whileHover={{ scale: 1.02 }} 
                  whileTap={{ scale: 0.98 }}
          ...
          {/* RENDERING ONLY ALLOWED GUEST TOOLS */}
          {activeTool && (
