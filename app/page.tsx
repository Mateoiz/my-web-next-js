...
import UpcomingEventToast from "./components/UpcomingEventToast"; // Fixed import path
...
export default function Home() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 relative z-10 overflow-hidden transition-colors duration-300">
      
      {/* --- INTEGRATED COMPONENT: EVENT TOAST --- */}
      <UpcomingEventToast />

      {/* Decorative Background Glow - Adjusted opacity for light mode */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-green-500/10 dark:bg-green-500/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      >
        ...
        >
          {/* LAYER 1: Base Text */}
          {/* ADAPTED: Now dark gray in Light Mode, light gray in Dark Mode */}
        ...
        <motion.h2 
          ...
          className="text-2xl md:text-4xl font-light text-green-600 dark:text-green-400 tracking-widest uppercase transition-colors duration-300"
        >
        ...
        <motion.p 
          ...
          // ADAPTED: Text color for readability
          className="text-zinc-600 dark:text-zinc-300 text-lg md:text-xl max-w-2xl mx-auto pt-4 transition-colors duration-300" 
        >
      ...
      >
        ...
        <Link 
          href="/About"
          // ADAPTED: Border and text colors
        ...
        <Link 
          href="/Contact"
          // ADAPTED: Background and text colors
          className="px-8 py-4 bg-green-600 hover:bg-green-500 text-white dark:text-black font-bold rounded-full shadow-lg hover:shadow-[0_0_35px_rgba(34,197,94,0.6)] transition-all flex items-center gap-2 transform hover:scale-105"
        >
